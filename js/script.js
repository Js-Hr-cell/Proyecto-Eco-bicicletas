const equipo = [
    ...
    },
    {
        ...
        descripcion: 'Encargada de las métricas, análisis de presupuestos y estrategias de marketing online.',
...
if (formFinanzas) {
    formFinanzas.addEventListener('submit', function (e) {
        ...
        let html = `<div style="color: rgb(20, 95, 37); font-weight: bold; text-align: center; font-size: 14px;">Presupuesto Estimado: $${totalPresupuesto.toLocaleString('es-CL')} CLP / mes</div>`;

        if (totalPresupuesto > 50000) {
            html += `<div style="background-color: #fff3cd; color: #856404; border: 1px solid #ffeeba; border-radius: 6px; padding: 10px; margin-top: 10px; text-align: center; font-weight: bold;">⚠️ Advertencia: el presupuesto mensual supera los $50.000</div>`;
        }
